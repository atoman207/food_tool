const en = {
  ...
  admin: {
    ...
    productStorageCondition: "Storage Condition",
    ...
    qrTitle: "QR Redirect",
    qrDescription: "Set the redirect URL when users visit yourdomain.com/go. The QR code always points to /go so you can change the destination without reprinting.",
